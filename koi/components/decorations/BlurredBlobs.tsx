...
const BlurredBlobs = () => {
  return (
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none ">
      ...
      {/* TL */}
      <div
        className='absolute rounded-full mix-blend-multiply filter blur-2xl opacity-80 [animation:blob2_6s_infinite_2s] bg-linear-60 from-[var(--color-Mauve)] to-[var(--color-pale)] top-0 right-0 w-80 h-80 '
      ></div>
      {/* BR */}
      <div
      ...
      {/* BL */}
      <div
        className='absolute rounded-full mix-blend-multiply filter blur-3xl opacity-70 [animation:blob3_3s_infinite_2s] bg-linear-60 from-[var(--color-sky-blue)] to-[var(--color-pale-purple1)] bottom-0 left-0 w-60 h-60 lg:w-100 lg:h-100 xl:w-110 xl:h-110'
      ></div>
    </div>
  )
}
